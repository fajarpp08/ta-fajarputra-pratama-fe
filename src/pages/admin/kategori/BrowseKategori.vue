  ...
  <div class="relative min-h-screen">
    <div class="min-h-screen mx-auto flex flex-wrap p-5 flex-col md:flex-row">
      <div class="md:col-span-2 xl:col-span-3">
        <h3 class="text-2xl tracking-tight font-bold">Tenda</h3>
      </div>
          ...
          <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
            <div class="overflow-hidden">
              ...
              <table class="min-w-full text-left text-sm font-light" v-if="mode == 'browse'">
                ...
                <tbody>
                  <tr v-for="(a, index) in dataTenda" :key="a.id" class="border-b dark:border-neutral-500">
...
export default defineComponent({
  ...
  methods: {
    ...
    onSelect(data) {
      this.mode = "form";
      this.$refs["formKategori"].selectData(data);
    },
    onSearching(event) {
      this.loadData();
    },
