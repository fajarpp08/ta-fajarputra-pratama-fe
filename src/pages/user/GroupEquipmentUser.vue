<template>
  <div class="bg-white py-0">
    ...
    <div class="w-full inline-flex py-4 px-6">
      <input v-model="queryData.name" @keyup="onSearching()"  placeholder="Masukan nama group equipment"
...
export default defineComponent({
  ...
  methods: {
    ...
    loadData() {
      api.get("groupequipment/user", this.queryData).then((respon) => {
    ...
    onSelect(data) {
      this.$router.push("/equipmentuser");
    },
  },
});
</script>
