        ...
        <div class="mx-auto max-w-7xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
            ...
            <div class="mt-6 h-full w-2/5 rounded-lg border bg-white p-6 shadow-md md:mt-0 ">
                ...
                <div class="mb-2 flex justify-between">
                    ...
                    <!-- <p class="text-gray-700">Fajar Putra Pratama</p> -->
                </div>
                <div class="mb-2 flex justify-between">
                ...
                <div class="mb-2 flex justify-between">
                    <p class="text-gray-700">Nomor Telepon</p>
                ...
                <!-- <div class="flex justify-between">
                    <p class="text-gray-700">Pilih Metode Bayar</p>
                </div> -->
                <hr class="my-4" />
                <div class="flex justify-between">
                    <p class="text-lg font-bold">Total</p>
                    <div class="">
                        <p class="mb-1 text-lg font-bold">Rp. 100.000</p>
                    </div>
                </div>
