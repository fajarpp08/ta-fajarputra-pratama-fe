<template>
  ...
  <footer class="relative z-10 bg-gradient-to-t from-blue-600 to-transparent pt-24">
    <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 sm:w-2/3 lg:w-2/6">
          <div class="mb-10 w-full">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              <img src=".././../assets/icon.png" class="h-16 w-16" alt="icon" />
              <span class="ml-2 font-bold text-xl ">Jelajah Alam Sumbar</span>
            </a>
            <p class="text-body-color mb-7 text-base">
              Jelajah Alam Sumbar merupakan
              toko rental alat outdoor terbaik
              dan terlengkap di Kota Padang.
            </p>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-4/12 flex justify-end">
          <div class="mb-10 w-full">
            ...
            <div class="mb-6 flex justify-end">
              ...
              <a href="https://twitter.com/Dedekfpp"
                class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
              ...
              <a href="https://www.instagram.com/dedekfajarpp/?hl=id"
                class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                <!-- <svg width="16" height="12" viewBox="0 0 16 12" class="fill-current">
                  <path
              ...
              <a href="https://www.linkedin.com/in/fajar-putra-pratama"
                class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
